...
const SUBCATEGORY_ALIASES: Record<string, string> = {
  ...
  crossbody: "crossbodybags",
  crossbodybag: "crossbodybags",
  crossbodybags: "crossbodybags",
  hobo: "hobobags",
  hobobag: "hobobags",
  hobobags: "hobobags",
  bucket: "bucketbags",
  bucketbag: "bucketbags",
  bucketbags: "bucketbags",
  handbag: "handbags",
  handbags: "handbags",
  minibag: "minibags",
  minibags: "minibags",
...
const INFER_RULES: Array<{ slug: string; parent: string; rx: RegExp }> = [
  ...
  { slug: "dressshoes", parent: "footwear", rx: /(туфл|дерби|derby|оксфорд|oxford|монк|monk\s*strap)/i },
  ...
  { slug: "shoulderbags", parent: "bags", rx: /(сумк.*через\s*плеч|плечев.*сумк|shoulder\s*bag)/i },
  { slug: "crossbodybags", parent: "bags", rx: /(кроссбоди|cross[\s-]?body)/i },
  { slug: "hobobags", parent: "bags", rx: /(хобо|hobo)/i },
  { slug: "bucketbags", parent: "bags", rx: /(бакет|bucket\s*bag)/i },
  { slug: "minibags", parent: "bags", rx: /(мини[\s-]?сумк|mini[\s-]?bag)/i },
  { slug: "totes", parent: "bags", rx: /(тоут|tote|шопер|shopper)/i },
  { slug: "handbags", parent: "bags", rx: /(хендбег|handbag)/i },
