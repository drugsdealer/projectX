            ...
            {variant === "moscow" ? (
              ...
              <>
                ...
                <div>
                  ...
                  <p>
                    В регионы отправляем <strong>только СДЭК</strong> — до
                    пункта выдачи или курьером до двери. Доставка по России{" "}
                    <strong>платная</strong>: стоимость зависит от региона, веса
                    и габаритов, её рассчитает и согласует менеджер после
                    оформления заказа.
                  </p>
                </div>
              </>
