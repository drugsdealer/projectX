...
export const Header: React.FC<Props> = ({ className }) => {
    const { title } = useTitle(); // Получаем название из контекста
            ...
            <div>
                <Container className='flex items-center justify-between py-8'>
                    ...
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            <h1 className="text-2xl uppercase font-black cursor-pointer">{title}</h1>  {/* Используем динамический заголовок */}
