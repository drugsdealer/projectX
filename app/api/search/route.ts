...
const TYPE_NAME_ALIASES: Record<string, string[]> = {
  sneaker: ['sneaker', 'sneakers', 'кроссовки', 'кроссовок', 'кеды', 'кед', 'tabi', 'future', 'replica', 'gat'],
  sneakers: ['sneaker', 'sneakers', 'кроссовки', 'кроссовок', 'кеды', 'кед', 'tabi', 'future', 'replica', 'gat'],
